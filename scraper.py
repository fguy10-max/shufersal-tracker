...
def categorize(name, brand):
    ...
    veggie_exact = ['עגבניה','מלפפון ','גזר ','חסה ','פלפל ירוק','פלפל אדום',
                    ...
                    'פלפל פאלמרו',"פלפל צילי",'בצל ירוק','בצל יבש','בצל אדום',
    ...
    if any(w in n for w in fruit_exact):
        if not any(ex in n for ex in ['מיץ','סירופ','שוופס','ספרייט',"גלי",
    ...
    # ── סוכריות ──
    if any(w in n for w in ['סוכרייה','מסטיק ','טיק טק','סקיטלס',"גלי ",'לוקיטוס','חמצוץ']):
        return 'candy'

    # ── חטיפים מלוחים ──
    if any(w in n for w in ['דוריטוס','פרינגלס','תפוציפס',"תפוציפס",
    ...
    if any(w in n for w in ['מיץ ','פריגת','ספרינג ','ספרייט','קולה ','פנטה',
                             ...
                             'מים מצוננ','מים ','שוופס','פיוז-טי',"גאמפ ",
